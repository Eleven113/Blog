...
<div id="author">
    ...
    <div id="author-biography">
        ...
        <br/>
        <div class="biography-title"><i class="fas fa-circle"></i>&nbsp;&nbsp;Jeunesse</div>
        <br/>
        ...
        <br/>
        <div  class="biography-title"><i class="fas fa-circle"></i>&nbsp;&nbsp;Débuts chez Disney</div>
        <br/>
        ...
        <br/>
        <div  class="biography-title"><i class="fas fa-circle"></i>&nbsp;&nbsp;Un auteur prolifique</div>
        <br/>
        ...
        <br/>
        <div  class="biography-title"><i class="fas fa-circle"></i>&nbsp;&nbsp;Accès à la reconnaissance avec La Jeunesse de Picsou</p></div>
        <br/>
        ...
        <br/>
        <div  class="biography-title"><i class="fas fa-circle"></i>&nbsp;&nbsp;Problèmes de santé et arrêt de travail</div>
        <br/>
